...
def cek():
	...
	for url in finallist:
		print (R+"[!] "+W+"SCANNING WEBS VULN-_-_-_\r"),;sys.stdout.flush()
		EXT = "'"
		host = url+EXT
		try:
...
if __name__ == "__main__":
	...
	print (R+"   | $$$/ \  $$$| $$_____/| $$  | $$| $$  | $$ /$$__  $$  \  $$$/    ")
	print (R+"   | $$/   \  $$|  $$$$$$$| $$$$$$$/| $$$$$$$/|  $$$$$$$   \  $/     ")
	print (R+"   |__/     \__/ \_______/|_______/ |_______/  \_______/    \_/      ")
	print (G+"   MODED BY: TheSploit")
	print (G+"   TYPE: SIMPLE TOOLS CHECK DORKING WEBSITE")
	print (G+"   TEAM: Solo No Team")
	print (G+"   Thanks for Use This Tools")
	print (G+"   VERSION: 9.1")
	print (W+43*"=")

	inurl = raw_input(B+"[~]"+G+" URL-DORK    "+W+": ")
	site  = raw_input(B+"[~]"+G+" SITE        "+W+": ")
	maxc  = raw_input(B+"[~]"+G+" MAX PAGES   "+W+": ")
